			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 additional-nav">
					<ul class="list-unstyled list-inline pull-right">
						<li><a href="${pageContext.request.contextPath}/topbar.jsp">Trang chủ</a></li>
						<li><a href="shop-wishlist.html">Sản phẩm</a></li>
						<li><a href="${pageContext.request.contextPath}/views/login.jsp">Đăng nhập</a></li>
						<li><a href="${pageContext.request.contextPath}/views/register.jsp">Trang quản trị</a></li>
					</ul>
				</div>
				<!-- END TOP BAR MENU -->
			</div>
			...
			<div class="header-navigation">
				<ul>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li class="active"><a href="shop-index.html">Home
									Default</a></li>
